...
function Dashboard() {
    ...
    const [yesterdayServices, setYesterdayServices] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const handleDateSelect = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Dashboard.useCallback[handleDateSelect]": (selectedDate)=>{
            setDate(selectedDate);
            if (selectedDate) {
                loadServicesForDate(selectedDate);
                const yesterday = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$subDays$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["subDays"])(selectedDate, 1);
                const yesterdayData = allServices.filter({
                    "Dashboard.useCallback[handleDateSelect].yesterdayData": (s)=>s.timestamp.startsWith(yesterday.toISOString().split('T')[0])
                }["Dashboard.useCallback[handleDateSelect].yesterdayData"]);
                setYesterdayServices(yesterdayData);
            }
        }
    }["Dashboard.useCallback[handleDateSelect]"], [
        loadServicesForDate,
        allServices
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Dashboard.useEffect": ()=>{
            if (date) {
                ...
                const yesterday = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$subDays$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["subDays"])(date, 1);
                const yesterdayData = allServices.filter({
                    "Dashboard.useEffect.yesterdayData": (s)=>s.timestamp.startsWith(yesterday.toISOString().split('T')[0])
                }["Dashboard.useEffect.yesterdayData"]);
                setYesterdayServices(yesterdayData);
            }
        }
    }["Dashboard.useEffect"], [
    ...
    const reportData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "Dashboard.useMemo[reportData]": ()=>{
            let totalSales = 0;
            let totalCommissions = 0;
            const staffCommissions = {};
            services.forEach({
                "Dashboard.useMemo[reportData]": (service)=>{
    ...
    const yesterdayTotalSales = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "Dashboard.useMemo[yesterdayTotalSales]": ()=>{
            return yesterdayServices.reduce({
                "Dashboard.useMemo[yesterdayTotalSales]": (acc, service)=>acc + service.price
            }["Dashboard.useMemo[yesterdayTotalSales]"], 0);
        }
    }["Dashboard.useMemo[yesterdayTotalSales]"], [
        yesterdayServices
    ]);
    const salesDifference = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "Dashboard.useMemo[salesDifference]": ()=>{
    ...
    const paymentBreakdown = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "Dashboard.useMemo[paymentBreakdown]": ()=>{
            const cash = services.filter({
                "Dashboard.useMemo[paymentBreakdown].cash": (s)=>s.paymentMethod === 'cash'
            }["Dashboard.useMemo[paymentBreakdown].cash"]).reduce({
                "Dashboard.useMemo[paymentBreakdown].cash": (acc, s)=>acc + s.price
            }["Dashboard.useMemo[paymentBreakdown].cash"], 0);
            const machine = services.filter({
                "Dashboard.useMemo[paymentBreakdown].machine": (s)=>s.paymentMethod === 'machine'
            }["Dashboard.useMemo[paymentBreakdown].machine"]).reduce({
                "Dashboard.useMemo[paymentBreakdown].machine": (acc, s)=>acc + s.price
            }["Dashboard.useMemo[paymentBreakdown].machine"], 0);
            const coupons = services.filter({
                "Dashboard.useMemo[paymentBreakdown]": (s)=>s.hasCoupon
            }["Dashboard.useMemo[paymentBreakdown]"]).length;
            const notPaid = services.filter({
                "Dashboard.useMemo[paymentBreakdown].notPaid": (s)=>!s.isPaid
            }["Dashboard.useMemo[paymentBreakdown].notPaid"]).reduce({
                "Dashboard.useMemo[paymentBreakdown].notPaid": (acc, s)=>acc + s.price
            }["Dashboard.useMemo[paymentBreakdown].notPaid"], 0);
            return {
                cash,
                machine,
                coupons,
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        className: "flex items-center ".concat(salesDifference >= 0 ? 'text-green-500' : 'text-red-500'),
                                        children: [
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DialogContent"], {
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DialogHeader"], {
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DialogTitle"], {
                                                        children: t('payment-details-label')
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/components/dashboard/dashboard.tsx",
                                                        lineNumber: 187,
                                                        columnNumber: 23
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                            children: [
                                                                t('payment-method-machine'),
                                                                ": ",
                                                                paymentBreakdown.machine.toFixed(2),
                                                                " ",
                                                                t('sar')
                                                            ]
                                                        }, void 0, true, {
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                            children: [
                                                                ...
                                                                ": ",
                                                                paymentBreakdown.notPaid.toFixed(2),
                                                                " ",
                                                                t('sar')
                                                            ]
                                                        }, void 0, true, {
...
_s(Dashboard, "nkHYE7ETJwoZgDUQZ1maDCdpA/M=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$app$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useApp"]
    ];
});
...
function DashboardPage() {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$app$2d$shell$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AppShell"], {
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$dashboard$2f$dashboard$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Dashboard"], {}, void 0, false, {
...
//# sourceMappingURL=src_88e35c70._.js.map